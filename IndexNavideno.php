...
<body>
  ...
  <main>
    ...
    <!-- Banner Navideño (TOQUE SUTIL) -->
    <div class="navidad-banner">
      <img src="imagenes/santa-hat.webp" alt="Gorro de Santa" class="navidad-hat" />
      <span>¡Feliz Navidad y Próspero Año Nuevo!</span>
    </div>


    <!-- Contenedor para los copos de nieve -->
    <div class="snowflakes" aria-hidden="true">
      <!-- Puedes duplicar o reducir cuántos “copos” quieras -->
    ...
    <div class="santa-sleigh">
      <img src="imagenes/santa-trineo.png" alt="Santa en su trineo" />
    </div>


    <!-- Árbol de Navidad en la esquina -->
    <div class="arbol-navidad">
      <img src="imagenes/arbol.webp" alt="Árbol de Navidad" />
    </div>
