...
<body>
  ...
  <div id="welcome-message" style="font-weight: bold; color: #090643; font-size: 30px; padding: 15px"></div>
  ...
  <main>
    ...
    <!-- ============================================= -->
    <!-- Sección para listar Incidencias              -->
    <!-- ============================================= -->
    <section class="h2TablaIncidencias" id="h2TablaIncidencias">
      ...
      <table border="1" class="tabla_incidencias" style="width: 90%; margin:20px auto; border-collapse:collapse;">
        <thead>
          <tr>
            <th>ID</th>
            <th>Título</th>
  ...
  <script>
    ...
    if(btnNuevaIncidencia){
      btnNuevaIncidencia.addEventListener("click", () => {
        alert("Aquí abrirías un formulario para reportar o agregar una nueva incidencia.");
      });
    }
  </script>
  <script src="../App.js"></script>
